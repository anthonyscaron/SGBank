...
namespace SGBank.Tests
{
    ...
    public class FreeAccountTests
    {
        ...
        [TestCase("12345", "Free Account", 100, AccountType.Free, 100, false)] //fail, positive number withdrawal
        [TestCase("12345", "Free Account", 100, AccountType.Free, -250, false)] // fail, negative number withdrawal over limit
        [TestCase("12345", "Free Account", 100, AccountType.Basic, -50, false)] // fail, not a free account type
        [TestCase("12345", "Free Account", 50, AccountType.Free, -100, false)] // fail, overdraft
        [TestCase("12345", "Free Account", 100, AccountType.Free, -50, true)] //success
